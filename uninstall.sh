...
#
# Yang dihapus:
#   - ~/Applications/Axioo-Control-Center-*.AppImage (+ duplikat AppImageLauncher)
#   - ~/.local/share/applications/axioo-control-center.desktop
#   - ikon axioo-control-center (termasuk ekstraksi appimagekit_*)
#   - dist/*.AppImage + dist/AppDir (+ dist/icon.png bila tak dipakai lagi)
#
...
echo "[1/4] ~/Applications"
rm_one "AppImage terinstall" "$HOME"/Applications/Axioo-Control-Center-*.AppImage
